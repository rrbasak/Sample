...
public class Observer {
	...
	public void save(@RequestPart("dob") String dob, @RequestPart("email") String email,
			...
			@RequestPart(name = "fb", required = false) String fb,
			@RequestPart(name = "insta", required = false) String insta,
			@RequestPart(name = "twitter", required = false) String twitter, @RequestPart("name") String name,
	...
	@Async
	public void UpdateUser(@RequestPart(name = "dob", required = false) String dob,
			...
			@RequestPart(name = "id", required = false) Integer id,
			@RequestPart(name = "desx", required = false) String desx,
			@RequestPart(name = "about", required = false) String about, @RequestPart("address") String address,
